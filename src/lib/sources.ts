...
export const SOURCES: SourceDef[] = [
  ...
  // ─── Злободневное: запреты и ограничения в интернете и культуре ──────────
  // Нужно редко и дозированно — разбавить ленту модных новостей тем, что
  // реально задевает аудиторию: блокировки, VPN, штрафы за музыку.
  // Обычную политику и происшествия отсеивает разбор.
  {
    slug: 'meduza',
    name: 'Медуза',
